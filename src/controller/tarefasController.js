...
/*4°) Recebe as informações do botão que está no addtarefas.handlebar e efetua o cadastro no banco de dados, depois ele volta para a listagem das tarefas */
router.post('/tarefas/nova', (req, res) => {
    var tarefas = new Tarefas(); tarefas.nome = req.body.nome; 
    tarefas.descricao = req.body.descricao; tarefas.save().then(() => {
